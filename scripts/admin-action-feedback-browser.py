...
async def main():
    ...
    async with async_playwright() as p:
        ...
        await page.locator('[data-review-survey="euclid"]').click()
        await page.locator('[data-review-filter="pending"]').click()
        await page.locator('#review-survey-dialog [data-edit-product]').first.click()
        ...
        await page.locator('#review-survey-close').click()
