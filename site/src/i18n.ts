...
const messages: Record<Locale, Record<string, string>> = {
  ...
  zh: {
    ...
    "page.resources.explainerKicker": "怎样阅读一个产品",
    "page.resources.explainerTitle": "从天空位置走到官方数据",
    "page.resources.explainerLead": "每个产品页面按五个问题展开，让覆盖地图成为可以使用的结论，而不是一堆文件。",
    "page.resources.explainer1Title": "选择天空区域",
    ...
    "page.resources.explainer3Title": "读懂精度",
